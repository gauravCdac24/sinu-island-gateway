...
const ForumHero = ({ description, eventLabel }: ForumHeroProps) => {
    ...
    <div className="relative overflow-hidden bg-university-dark-gray h-[82vh] min-h-[440px] sm:h-[86vh] md:h-[92vh]">
      ...
      >
        <OptimizedImage
          ...
          alt="SINU students and campus community dialogue"
      ...
      >
        ...
        >
          ...
          <p className="mb-2 text-xs leading-relaxed text-[#082952]/90 sm:text-sm">
            {description ||
              "Building a stronger university community through respectful dialogue between students and leadership."}
          </p>
          {eventLabel && (
            <p className="mb-3 flex items-center gap-1.5 text-xs font-medium text-[#082952]">
          ...
          <div className="mt-3 flex flex-wrap gap-x-3 gap-y-1 border-t border-white/20 pt-3 text-xs font-semibold">
            ...
            <button
              ...
              className="inline-flex items-center gap-1 text-[#082952] hover:underline"
              onClick={() => {
                document.getElementById("forum-answers")?.scrollIntoView({ behavior: "smooth" });
              }}
            >
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 bg-university-gold py-2.5 sm:py-3">
        <div className="animate-scroll whitespace-nowrap">
          <p className="inline-block px-4 text-xs font-semibold text-university-dark-gray sm:px-6 sm:text-sm md:text-base">
            Your voice matters — constructive questions help shape policy, services, and campus life at SINU.
          </p>
        </div>
      </div>
    </div>
