...
const TafeHero = () => {
  return (
    <section
      ...
      aria-labelledby="tafe-hero-title"
    >
      ...
      <div className="relative z-10 flex min-h-[min(88vh,820px)] flex-col justify-end px-4 pb-10 pt-24 sm:px-8 md:px-12 md:pb-14 lg:px-16">
        <div className="mx-auto w-full max-w-3xl text-center md:mx-0 md:text-left">
          ...
          >
            Practical skills for real careers
          </h1>
          <p className="mt-4 max-w-xl text-base leading-relaxed text-white/95 md:text-lg">
            Industry-focused vocational programmes that prepare you for work or further study. Explore
            course areas, check how to enrol, and apply online when applications are open.
          </p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
            ...
            >
              <Link to="/student-academic-support">Student support</Link>
            </Button>
          </div>
        </div>
      </div>
